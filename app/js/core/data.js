...
(function (root) {
   ...
   * ------------------------------------------------------------------------ */
  var STEELS = [
    { nome: 'ASTM A36',        fy: 250, fu: 400, fonte: 'norma' },
    { nome: 'ASTM A572 Gr.50', fy: 345, fu: 450, fonte: 'planilha' },
    { nome: 'ASTM A500 Gr.B',  fy: 290, fu: 400, fonte: 'norma' },
    { nome: 'ASTM A500 Gr.C',  fy: 317, fu: 427, fonte: 'norma' },
    { nome: 'ABNT VMB 350',    fy: 350, fu: 485, fonte: 'norma' },
  ...
  var MATERIALS = ['Inox AISI 316', 'Custo-benefício (galvanizado)'];
