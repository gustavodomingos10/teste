# ✅ VALIDAR.md — Registro central de valores técnicos

> **O coração do controle de qualidade Diamante.** Toda afirmação técnica com número
> (cobrimento, abertura de fissura, slump, fck, tolerância, tempo-limite, taxa de plataforma,
> preço de concorrente) entra aqui. Nenhum material é "pronto para publicar" com linha
> **pendente**. O engenheiro **Gustavo Domingos** revisa, confirma e assina antes da publicação.
> *O rigor de quem assina é parte do produto.*

**Legenda de status:** 🟡 pendente (aguarda confirmação do instrutor) · 🟢 confirmado · 🔵 fonte citada, revisar vigência

---

## A. Normas técnicas citadas no projeto (verificar número + nome + vigência)
...
> ⚠️ **Instrutor:** confirme a edição vigente de cada NBR na data da gravação (as normas recebem emendas). O texto do curso cita "número + nome"; nunca item/valor sem esta confirmação.

## B. Valores técnicos do CONTEÚDO — curso piloto (Fissuras e Trincas)
...
## C. Valores de MERCADO (copy, âncoras de preço) — exigem fonte com link e data
...
| # | Item | Status |
|---|---|---|
| D1 | Redação: "perito judicial **ATUANTE** em processos do TJ-PR e do TJ-SP" (nunca "perito DO tribunal") | 🟡 **VALIDAR redação final preferida** com o instrutor |
| D2 | CREA-PR nº 140.964-D e CREA-SP nº 5071652757 | 🟢 fornecido no Bloco 0 |
| D3 | 12 anos de experiência | 🟢 fornecido |
| D4 | Preço piloto R$ 49,90 (beta) → R$ 99,90 (cheio) | 🟢 definido |
| D5 | Combo vitalício R$ 497 à vista ou 12x de R$ 49,70 (nunca "sem juros") | 🟢 definido |
| D6 | Meta de alunos da turma beta (fase 1) | 🟡 [VALIDAR meta com instrutor] |
| D7 | Política de "acesso vitalício" (definição + compromisso mínimo declarado) | 🟡 [VALIDAR] redigir sem letra miúda enganosa |
...
2. Toda linha 🟡 precisa virar 🟢 (ou o material correspondente NÃO publica).
3. Toda linha 🔵 exige checar a **vigência** da norma na data da gravação.
4. Ao confirmar, troque o emoji e anote a data e a fonte na coluna de observação.

**Última atualização:** gerado na Etapa 0 · atualizado nas Etapas 2 e 4.
