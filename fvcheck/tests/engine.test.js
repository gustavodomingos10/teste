...
approx('Mx C1 = 0,105·w·L² = 2,5336 kN·m', R.checks.MxC1, 2.53357, 2e-3);
approx('Mx C3 = 4,3159 kN·m', R.checks.MxC3, 4.31587, 2e-3);
// resistências
...
// linearidade da reserva: aplicar a margem deve levar razão gravitacional a ≈1
var c2 = Engine.calcularChecks(m, R.reserva.gFvMax);
var pioresGrav = Math.max(c2.rV1, c2.rV3, c2.rV4, c2.rCargaTelha);
